...
boxShadow: "0px 0px 15px rgba(0, 0, 0, 0.15)"}} className="cd">
                       <div class="card mb-3" style={{width: "540px;"}}>
  <div class="row">
    <div class="col-md-4 ">
      <img style={{width:"100%" ,height:"200px"}} src={person} class="img-fluid rounded-start p-2" alt="..."/>
    </div>
    <div class="col-md-8">
      <div class="card-body">
      <div className="first">
...
<div class="card-body">
    ...
    <div class="s"><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p></div>
                ...
                <div className="col-lg-6 col-md-12 col-12">
                  ...
                  <div style={{background: "#FFFFFF",
boxShadow: "0px 0px 15px rgba(0, 0, 0, 0.15)"}} className="cont p-2">
